...
App({
  ...
  storeChannel: function(options) {
    console.log('storeChannel options', options)
    if (options && options.fd) {
      wx.setStorageSync("fd", options.fd);
    }
              ...
              getApp().request({
                ...
                success: function(result) {
                  ...
                  if (result.code == 0) {
                    ...
                    page_now.onShow();
                    page_now.onLoad(page_now.options);
