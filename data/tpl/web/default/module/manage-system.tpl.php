		...
		<tr ng-repeat="module in module_list" ng-if="module[support] == 2">
			...
			<td class="text-right">
				<?php  if(permission_check_account_user('see_module_manage_system_install')) { ?>
					...
					<a ng-if="module.cloud_id" ng-href="{{ 'http://www.wazyb.com' }}" target="_blank" class="btn btn-primary">&#x66f4;&#x591a;&#x5fae;&#x64ce;&#x5e94;&#x7528;</a>
					<?php  } ?>
					<?php  if($do == 'recycle') { ?>
						<?php  if(permission_check_account_user('see_module_manage_system_stop')) { ?>
...
<div class="distribution-steps">
	<div class="we7-margin-bottom-sm font-lg">资源邦提醒您<a href="http://www.wazyb.com" style="color:red;">【点击快去下载更多源码吧！】</a></div>
