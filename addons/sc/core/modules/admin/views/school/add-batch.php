...
<div class="main-nav" flex="cross:center dir:left box:first">
    <div>
        <nav class="breadcrumb rounded-0 mb-0" flex="cross:center">
            ...
            <a class="breadcrumb-item" href="<?= $urlManager->createUrl(['admin/school/index']) ?>">学校</a>
        ...
        <div class="form-title" style="border: 0;">
            <nav class="nav nav-tabs" id="myTab" role="tablist">
                <a class="nav-item nav-link active" id="nav-level-edit" data-toggle="tab" href="#level-edit"
                   role="tab"
                   aria-controls="level-edit" aria-selected="true">学校帐号生成</a>
            </nav>
        </div>
                ...
                <form method="post" class="auto-submit-form" autocomplete="off"
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-5">
                                <input class="form-control" name="model[end_num]" value="<?= $model->end_num ? $model->end_num : '1005' ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-2 text-right">
                                <label class="col-form-label">过期时间</label>
                            </div>
                            <div class="col-5">
                                <input class="form-control" name="model[expire_date]" value="">
                            </div>
                        </div>
                        </div>
