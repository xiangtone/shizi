...
<div class="main-body p-3" id="app">
    <a href="<?= $urlManager->createUrl(['admin/game/sentence-edit', 'video_id' => $video_id]) ?>" class="btn btn-primary">
        添加</a>
    ...
    <div class="float-right">
        ...
        <form method="get">
            ...
            <div class="input-group">
                <input class="form-control" placeholder="分段1" name="keyword" autocomplete="off"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl(['admin/game/sentence-edit', 'id' => $value['id'],'video_id' => $video_id]) ?>">修改</a>
                        
                        <a class="btn btn-sm btn-danger del" href="javascript:" data-content="是否删除？"
                           data-url="<?= $urlManager->createUrl(['admin/game/sentence-del', 'id' => $value['id']]) ?>">删除</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
...
<script type="text/javascript">
    ...
    function search() {
        ...
        $.ajax({
            url: "<?= $urlManager->createUrl(['admin/game/sentence-list']) ?>",
            dataType: "json",
            data: {
                keyword: keyword,
            },
