...
<div class="main-nav" flex="cross:center dir:left box:first">
    <div>
        <nav class="breadcrumb rounded-0 mb-0" flex="cross:center">
            ...
            <a class="breadcrumb-item" href="<?= $urlManager->createUrl(['admin/game/word-list', 'video_id' => $video_id]) ?>">组词列表</a>
        ...
        <div class="tab-content mt-4" id="nav-tabContent">
            <div class="tab-pane fade show active" id="level-edit" role="tabpanel" aria-labelledby="nav-level-edit">
                ...
                <form method="post" class="auto-submit-form" autocomplete="off"
                      data-return="<?= $urlManager->createUrl(['admin/game/word-list', 'video_id' => $video_id]) ?>">
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            <div class="col-2 text-right">
                                <label class="col-form-label required">词汇</label>
                            </div>
                            <div class="col-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="video-picker" data-url="<?= $urlManager->createUrl(['upload/video']) ?>">
                                ...
                                <!-- <a class="video-check"
                                   ...
                                   target="_blank">预览</a> -->
                                <audio src="<?= $exWord->voice_url ? $exWord->voice_url:''?>" controls="controls"></audio>
