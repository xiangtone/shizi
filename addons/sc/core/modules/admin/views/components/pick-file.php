        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="pick-image-box" id="pick_image_box">
                    <div style="font-size: 1.5rem">点击上传文件</div>
                    <div style="font-size: 1.5rem" class="uploading">正在上传...</div>
...
//        getPicList();
        ...
        function getPicList() {
            ...
            $.ajax({
                url: "<?=Yii::$app->urlManager->createUrl(['admin/system/upload-file-list'])?>",
                data: {
                    type: "image",
                    page: pic_list_page,
                },
