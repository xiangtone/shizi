...
<div class="sidebar">
    <div class="sidebar-nav">
        ...
        <div class="nav-group <?=$this->params['active_nav_group'] == 4 ? 'active' : null?>">
            ...
            <div class="sub-nav-list">
                <a href="<?=$urlManager->createUrl(['admin/comment/index'])?>">列表</a>
            </div>
        </div>
        <div class="nav-group <?=$this->params['active_nav_group'] == 5 ? 'active' : null?>">
            ...
            <div class="sub-nav-list">
                ...
                <a href="<?=$urlManager->createUrl(['admin/order/video'])?>">销售记录</a>
