...
class ClassesForm extends \app\models\Model
{
    ...
    public function getList()
    {
        ...
        if ($this->keyword){
            ...
            $sql_pagination = "SELECT   zjhj_video_classes.*,zjhj_video_user.*,zjhj_video_classes.id as class_id FROM zjhj_video_classes INNER JOIN zjhj_video_user ON zjhj_video_user.id=zjhj_video_classes.create_user_id WHERE  zjhj_video_classes.class_name='$this->keyword'";
        }else{
